class ConsultorsController < ApplicationController
  ...
  def index
    ...
    respond_to do |format|
      format.html
      format.json
      format.pdf { render template: 'consultors/reporte_consultores', pdf: 'reporte',layout: 'pdf.html'}
    end
  end
  ...
  private
    ...
    def consultor_params
      params.require(:consultor).permit(:nombre, :apellido, :edad, :direccion, :telefono)
    end
end
